...
const Scene = ({ selectedEquipment }) => {
    ...
    return (
        <Canvas style={{ height: '100vh' }} shadows>
            ...
            {selectedEquipment === 'scalpel' && <ScalpelModel />} {/* Render scalpel if selected */}
            {selectedEquipment === 'monitor' && <MonitorModel />} {/* Render monitor if selected */}
            {selectedEquipment === 'foreceps' && <ForcepsModel />} {/* Render forceps if selected */}
